...
qcplot <- function(){
  ...
  SaveSeuratRds(seurat_obj, file='uploaded_qcplot.RDS')
}
...
qc <- function(min.features, max.features, max.mtpercent, res){
  seurat_obj <- readRDS("~/single_cell_rnaseq/app-api/uploaded_qcplot.RDS")
  ...
  uploaded_file <<- seurat_obj
  SaveSeuratRds(seurat_obj, file='qc.RDS')
...
norm_pca <- function(scaling_factor, num_hvgs, norm_method, hvg_method, res){
  seurat_obj <- readRDS("~/single_cell_rnaseq/app-api/qc.RDS")
  ...
  SaveSeuratRds(seurat_obj, file='norm_pca.RDS')
...
clustering_umap <- function(dim, resolution){
  seurat_obj <- readRDS("~/single_cell_rnaseq/app-api/norm_pca.RDS")
...
clustering_tsne <- function(dims, resolution){
  ...
  print(t)
  uploaded_file <<- seurat_obj
  SaveSeuratRds(seurat_obj, file='clustering_tsne.RDS')
...
annotation_sctype_umap <- function(tissue){
  ...
  seurat_obj <- readRDS("~/single_cell_rnaseq/app-api/clustering_umap.RDS")
...
annotation_sctype_tsne <- function(tissue){
  ...
  seurat_obj <- readRDS("~/single_cell_rnaseq/app-api/clustering_tsne.RDS")
  ...
  # prepare gene sets
    ...
    uploaded_file <<- seurat_obj
    SaveSeuratRds(seurat_obj, file='annotation_sctype_tsne.RDS')
}
